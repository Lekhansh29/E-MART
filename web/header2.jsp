<%-- 
    Document   : header
    Created on : 24 Oct, 2024, 2:57:44 PM
    Author     : Aayush Nagar
--%>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
      <div class="container-fluid">
        <a href="index.jsp" class="navbar-brand"> E-Mart </a>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mynav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a href="shippedItems.jsp" class="nav-link">Shipped</a>
            </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
      <div class="container-fluid">
        <a href="userHome.jsp" class="navbar-brand"> E-Mart </a>
